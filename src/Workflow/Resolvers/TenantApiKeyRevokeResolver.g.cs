...
internal sealed class TenantApiKeyRevokeResolver : IEntityIdentifierResolver<TenantApiKeyRevokeCommand>
{
    ...
    public TenantApiKeyRevokeResolver(IEntityTypeResolver entityTypeResolver)
    {
        _entityTypeResolver = entityTypeResolver ?? throw new ArgumentNullException(nameof(entityTypeResolver));
    }

    public Task<EntityIdentifier> Resolve(TenantApiKeyRevokeCommand input, WorkflowContext context, CancellationToken cancellationToken)
    {
